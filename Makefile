...
cochatter : comsg_chatterer.o comsg.o coproc.o comutex.o
	$(CC) $(CCFLAGS) $(LIB_PARAMS) $(INC_PARAMS)  -o $(OUTDIR)/cochatter $(foreach o, $^, $(BUILDDIR)/$o)

comsg_chatterer.o : src/bin/comsg_chatterer.c include/comsg.h \
	src/ukernel/include/sys_comsg.h include/coport.h \
	include/comutex.h
	$(CC) $(CCFLAGS) $(INC_PARAMS) -c src/bin/comsg_chatterer.c -o $(BUILDDIR)/comsg_chatterer.o
